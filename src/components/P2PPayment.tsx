          ...
          try {
            ...
            if (qrData.type === 'fluxpay' && qrData.phone) {
              ...
              toast({
                ...
                description: `Found ${qrData.name || qrData.phone}`,
              });
            ...
            if (decodedText.startsWith('upi://')) {
              toast({
                ...
                description: "This is a UPI QR code. Please use a FluxPay QR code for P2P payments.",
                variant: "destructive",
              });
            } else {
              toast({
    ...
    <>
      <div className="container mx-auto p-4 sm:p-6">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold gradient-text">Send Money</h1>
            <p className="text-sm text-muted-foreground">Transfer money to friends and family</p>
          </div>
        </div>
